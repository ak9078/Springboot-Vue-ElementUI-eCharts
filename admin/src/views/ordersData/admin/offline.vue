          ...
          <el-row :gutter="32">
            <el-col :xs="24" :sm="24" :lg="16">
              <div class="chart-wrapper">
                ...
                <OfflineBarChart :chartOptions="chartOptions" />
              </div>
            </el-col>
...
import OfflineBarChart from "@/components/Common/BarChart";
import RankingTable from "@/components/Common/RankingTable";

export default {
  name: "OfflineDataAdmin",
  components: {
    PanelGroup,
    OfflineBarChart,
    RankingTable
  ...
  methods: {
    ...
    async channelRangeChange($event) {
      ...
      if (that.channelRangeValue.length > 0) {
    ...
    async getBarChartData() {
      ...
      let _channelRangeValue = that.channelRangeValue.join().split(",");
      if (_channelRangeValue == "") {
        _channelRangeValue = ["2", "3", "4"];
      }
