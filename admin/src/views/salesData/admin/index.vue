  ...
  <div class="dashboard-editor-container">
    ...
    <el-card class="box-card chart-main">
      ...
      <el-tabs v-model="tabsActiveName" @tab-click="handleClick">
        <el-tab-pane label="下单额" name="first" :lazy="true">
          <el-row :gutter="32">
            <el-col :xs="24" :sm="24" :lg="16">
              <div class="chart-wrapper">
                <div class="chart-wrapper-title">销售额趋势</div>
                <BarChart :chartOptions="chartOptions" />
              </div>
            </el-col>
            <el-col :xs="24" :sm="24" :lg="8">
              <div class="chart-wrapper">
                <div class="chart-wrapper-title">销售额排名</div>
                <RankingTable
        ...
        <el-tab-pane label="开票额" name="second" :lazy="true">
          <el-row :gutter="32">
            <el-col :xs="24" :sm="24" :lg="16">
              <div class="chart-wrapper">
                <div class="chart-wrapper-title">交付额趋势</div>
                <BarChart :chartOptions="chartOptions" />
              </div>
            </el-col>
            <el-col :xs="24" :sm="24" :lg="8">
              <div class="chart-wrapper">
                <div class="chart-wrapper-title">交付额排名</div>
                <RankingTable
                  :rankingLoading="rankingLoading"
                  :rankingTabList="rankingTabList"
                />
        ...
        <el-tab-pane label="回款额" name="third" :lazy="true">
          <el-row :gutter="32">
            <el-col :xs="24" :sm="24" :lg="16">
              <div class="chart-wrapper">
                <div class="chart-wrapper-title">回款额趋势</div>
                <BarChart :chartOptions="chartOptions" />
              </div>
            </el-col>
            <el-col :xs="24" :sm="24" :lg="8">
              <div class="chart-wrapper">
                <div class="chart-wrapper-title">回款额排名</div>
                <RankingTable
                  :rankingLoading="rankingLoading"
                  :rankingTabList="rankingTabList"
                />
        ...
        <el-tab-pane label="超期未回" name="fourth" :lazy="true">
          <el-row :gutter="32">
            <el-col :xs="24" :sm="24" :lg="16">
              <div class="chart-wrapper">
                <div class="chart-wrapper-title">超期未回趋势</div>
                <BarChart :chartOptions="chartOptions" />
              </div>
            </el-col>
            <el-col :xs="24" :sm="24" :lg="8">
              <div class="chart-wrapper">
                <div class="chart-wrapper-title">超期未回排名</div>
                <RankingTable
                  :rankingLoading="rankingLoading"
                  :rankingTabList="rankingTabList"
                />
...
import {
  getBySysAccountIds,
  rankingData
} from "@/utils/tool/dataPlatform/statSales";
...
export default {
  ...
  methods: {
    ...
    async dataRangeChange($event) {
      ...
      if ($event.length > that.dataRangeOptions.length) {
        console.log("全不选");
        isCheckAll = 2;
        // 相应数据也取消
    ...
    async dataRangeAll() {
      let that = this;
      let options = that.dataRangeOptions;
      if (that.dataRangeValueList.length < options.length) {
        // 全选上
        that.dataRangeValueList = options.map(item => {
          return item.value;
        });
    ...
    async getBarChartData() {
      ...
      let response = await getBySysAccountIds(params);
      if (response.code == 0) {
        let responseData = response.data || [];
